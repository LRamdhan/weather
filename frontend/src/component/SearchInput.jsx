...
const SearchInput = () => {
  ...
  return (<div className="flex items-center justify-between p-5 border-b-[1.5px] border-second dark:border-darkOuter border-solid sm:max-md:py-7 sm:max-md:px-[43px] md:px-8 md:py-4">
    ...
    <input type="text" placeholder="Search city..." onKeyUp={search} ref={input} value={searchInput} onInput={event => setSearchInput(event.target.value)} className="w-0 flex-1 bg-transparent text-lg placeholder:text-second dark:placeholder:text-darkOuter placeholder:font-medium placeholder:text-lg outline-none px-3 sm:max-md:text-[28px] sm:max-md:placeholder:text-[28px] sm:px-7 md:text-lg md:placeholder:text-lg md:px-3"/>
