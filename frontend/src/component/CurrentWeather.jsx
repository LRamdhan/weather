...
const CurrentWeather = () => {
  ...
  return (
    <div className="px-4 sm:px-28 md:px-28">
      <div className="max-w-[1040px] mx-auto mt-6 sm:mt-3 md:mt-0 grid grid-cols-1 grid-rows-currentRow justify-items-center md:grid-rows-currentRowLg md:grid-cols-currentCol md:grid-align-items-center md:justify-items-start">
        <img src={`/img/condition/${mainReducer.current.icon}.svg`} alt="something went wrong" className={`h-72 drop-shadow-condition sm:h-96 md:h-[420px] md:row-span-full ${skeletonReducer.contentDisplay} md:max-[1028px]:hidden`} />
        <div className={`aspect-square h-52 mt-16 rounded-full sm:h-64 sm:mt-24 md:mt-0 md:h-72 md:row-span-full bg-[#95CDFC] dark:bg-[#73ACD9] md:skeleton ${skeletonReducer.skeletonDisplay} md:max-[1028px]:hidden`}></div>
        <div className="md:flex md:items-center md:max-[1028px]:col-start-1 min-[1029px]:col-start-3 md:grid-align-self-item-end">
        ...
        <div className="flex justify-between w-full pt-16 sm:pt-20 md:pt-[77px] md:col-span-2 md:max-[1028px]:col-start-1 min-[1029px]:col-start-3 md:space-x-20 md:grid-align-self-item-start">
